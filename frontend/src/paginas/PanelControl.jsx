            ...
            {respuesta?.datos && (
                <div style={estilos.cajaRespuesta}>
                    ...
                    <div style={{ marginBottom: '15px' }}>
                        ...
                        {/* El Sistema A devuelve 'hashEnviado' */}
                    ...
                    <div style={{ marginBottom: '15px' }}>
                        ...
                        <span style={estilos.textoHash}>
                            {respuesta.datos.respuestaSistemaB?.carga?.hashRecibido || "Calculando..."}
                        </span>
                    </div>
                    ...
                    <div>
                        ...
                        <span style={{ marginLeft: '10px', backgroundColor: '#dcfce3', color: '#166534', padding: '4px 8px', borderRadius: '4px', fontWeight: 'bold' }}>
                            {respuesta.datos.respuestaSistemaB?.carga?.estadoIntegridad || "Verificado"}
                        </span>
                    </div>
                </div>
            )}
